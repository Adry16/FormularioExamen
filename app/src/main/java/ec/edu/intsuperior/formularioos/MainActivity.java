...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnAgregar,btnBuscar,btnBorrar,btnActualizar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String []opciones={"Argentina","Ecuador","Francia","China","London"};
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ejecutarServico("http://192.168.11.4/formulario_final/insertardatos.php");
            }});

        btnActualizar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarServico("http://192.168.11.4/formulario_final/modificarDatos.php");
            }
        });
        ...
        btnBorrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarServico("http://192.168.11.4/formulario_final/borrar_datos.php");
            }
        });
        ...
        btnBuscar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
            buscar("http://192.168.11.4/formulario_final/buscardatos.php?cedula="+cedula.getText()+"");
        }
    });
    }
