    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ejecutarServico("http://192.168.11.4/formulario_final/insertarProducto.php");
            }
        });
        btnBorrar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ejecutarServico("http://192.168.11.4/formulario_final/borrar_Pro.php");
            }
        });
        btnBuscar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                buscar("http://192.168.11.4/formulario_final/buscarProducto.php?codigo="+etCodigo.getText());
            }
        });
    }
